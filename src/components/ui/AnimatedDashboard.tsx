...
const DONUT_DATA = [
    { label: 'EP', value: 18, color: '#3b4a8a' },
    { label: 'US', value: 18, color: '#5563a8' },
    { label: 'JP', value: 14, color: '#7280c5' },
    { label: 'AU', value: 9, color: '#8e9ad5' },
    { label: 'KR', value: 9, color: '#6b7bc0' },
    { label: 'FR', value: 5, color: '#a0aadd' },
    { label: 'IN', value: 5, color: '#abb5e2' },
    { label: 'GB', value: 4, color: '#bbc3e8' },
    { label: 'BR', value: 2, color: '#c8ceec' },
    { label: 'CA', value: 2, color: '#d5d9f0' },
